...
function JoinForm() {
  ...
  // Absorbs JoinChoice's old job: a signed-in visitor who already has a cabinet is
  // forwarded straight past the registration form — never a server redirect, so
  // the cached public shell stays valid for everyone else.
  useEffect(() => {
    let cancelled = false;
